...
It's not a straightforward win. IO loans come with genuine trade-offs:
  ...
  - **Higher rates** — lenders typically charge a premium of 0.1–0.4% for IO loans versus P&I
  - **No equity build-up** — if property prices flatten or fall, you don't build a buffer
  - **Reversion risk** — when the IO period ends, repayments can jump significantly as you repay the same principal over a shorter term
  - **Harder to get** — APRA has tightened IO lending over recent years; lenders assess IO applications more carefully and some require a stronger serviceability buffer
  - **Discipline required** — the strategy only works if you're actually directing the saved cash flow productively (e.g. into an offset account on your home loan)
...
Interest-only isn't always the optimal choice. P&I may be better for investors when:
  ...
  - The property is positively geared — you're not relying on deductible interest to manage cash flow
  - You don't have an owner-occupied mortgage to pay down — the debt recycling argument disappears
  - You're close to retirement and want to reduce debt levels
  - You plan to eventually move into the property (converting it to your PPOR, where you'd want lower debt)
  - The IO premium is large enough to erode the tax benefit
