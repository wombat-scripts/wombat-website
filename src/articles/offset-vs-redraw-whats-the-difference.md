...
Which raises an awkward question, because the offset version usually costs more — typically a 0.10–0.30% higher rate, often with a $300–$400 annual package fee on top. On a $600,000 loan that can add up to [$20,000 or more over the life of the loan](/calculators/offset-vs-basic/) for a feature that saves you no additional interest whatsoever.
...
The basic loan with redraw tends to win when your home will always be your home, you're a disciplined saver, and the loan is at a genuinely lower rate with no fee — you pocket the price difference and lose little you'd actually use. Run your own numbers in the [offset vs basic calculator](/calculators/offset-vs-basic/); with savings going into redraw, you'll see exactly what the offset premium costs you.
...
Either way, the underlying strategy — keeping every spare dollar working against your loan — is the [quiet superpower of Australian mortgages](/calculators/extra-repayments/). The product choice just decides how much of the benefit you keep, and how much optionality you preserve.
