---
title: "Fortnightly repayments: the 13th payment most people miss"
description: "Two lenders can both offer 'fortnightly repayments' and mean completely different things. One version barely moves the dial. The other can cut years off your loan — here's how to tell them apart."
date: 2026-07-08
category: "Home Loans"
layout: article.njk
thumbnail: "/images/articles/calculations_lady.webp"
---

Ask most people why fortnightly repayments beat monthly ones and you'll hear something about interest compounding, or paying the bank "more often so less builds up." It sounds plausible. It's also only a small part of the reason — and depending on how your lender does the maths, switching to fortnightly might save you a fortune or barely move the dial.

There are two completely different ways a "fortnightly repayment" can be calculated, and the difference between them, on a typical Sydney-sized loan, runs to six figures. We've just built both methods into our [repayment calculator](/calculators/repayments/) so you can see the gap for yourself — but here's what's actually going on.
...
Notice what happened there: over a year, you pay exactly the same amount as you would monthly. Twelve months' worth of repayments, just sliced into 26 pieces instead of 12.

Now, in fairness, this version isn't worth *nothing*. Interest on your loan is calculated daily, so every payment that lands early sits in the loan shrinking the balance before the monthly interest charge. Paying fortnightly instead of monthly — even the same annual total — is worth roughly $12,000 over the life of the example loan below. Real money. But hold that number, because the second method saves about twelve times as much.
...
- **Pro-rata fortnightly:** $1,750 a fortnight — roughly $12,000 less interest from the earlier timing of payments, and a few months off the term
...
The [repayment calculator](/calculators/repayments/) now has both methods built in — choose fortnightly or weekly and you can flick between "standard" and "accelerated" to see your own balance chart fork in two. The gap between those lines is your money.
...
*Updated 9 July 2026: this article originally described the pro-rata method as saving "nothing you'd notice". An experienced broker rightly pointed out that because interest is calculated daily, paying fortnightly always saves something — I built a day-by-day model to check, and it's roughly $12,000 over the life of the example loan. The wording above now reflects that. The 13th payment is still doing the heavy lifting.*
