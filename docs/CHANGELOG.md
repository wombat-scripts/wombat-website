...
After a callback request, the success panel now says “Thanks. We will call you soon to lock in a Strategy Session.” and offers a proper primary button to `/book/` labelled “Prefer to pick a time with Tom yourself”. The inline “pick a time now” link is gone. Form fields, Netlify form name, validation, and hero copy are unchanged.
